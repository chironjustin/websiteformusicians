...
assert(!linkPromotionMigration.includes("EXCESSIVE_PUNCTUATION") && !linkPromotionMigration.includes("EXCESSIVE_UPPERCASE") && !linkPromotionMigration.includes("LONG_UNBROKEN_TOKEN") && !linkPromotionMigration.includes("EXCESSIVE_MENTIONS") && !linkPromotionMigration.includes("HTML_MARKUP") && !linkPromotionMigration.includes("position(U&'\\200D'"), "Link-promotion safety migration must preserve normal fan excitement and emoji composition as low-risk behavior.");
