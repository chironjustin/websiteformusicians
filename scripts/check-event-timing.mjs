...
assert(chatService.includes("joinEventChatIdentity") && chatService.includes("getOrCreateChatSessionId") && chatService.includes("supabase.rpc(CHAT_JOIN_RPC"), "Visitor chat names must use one-click event-scoped server-generated identity creation.");
