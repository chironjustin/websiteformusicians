...
assert(queueMigration.includes("grant execute on function public.submit_chat_message(uuid, uuid, text, uuid) to anon, authenticated"), "Visitor submit RPC execute grant must remain available to public visitors.");
...
assert(linkPromotionMigration.includes("grant execute on function public.submit_chat_message(uuid, uuid, text, uuid) to anon, authenticated"), "Link-promotion safety migration must preserve visitor submit RPC execution.");
