...
assert(riskMigration.includes("clean_body ~ '(.)\\1{24,}'") && riskMigration.includes("clean_body ~ '[!?.,]{40,}'") && !riskMigration.includes("EXCESSIVE_PUNCTUATION") && !riskMigration.includes("position(U&'\\200D'"), "Risk classifier must keep normal elongated fan excitement low and flag only extreme repeated filler.");
...
assert(linkPromotionMigration.includes("clean_body ~ '(.)\\1{24,}'") && linkPromotionMigration.includes("clean_body ~ '[!?.,]{40,}'") && !linkPromotionMigration.includes("EXCESSIVE_PUNCTUATION") && !linkPromotionMigration.includes("position(U&'\\200D'"), "Link-promotion safety migration must preserve normal fan excitement and emoji composition as low-risk behavior.");
