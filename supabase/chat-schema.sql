...
create table if not exists public.chat_risk_terms (
  ...
  match_mode text not null default 'substring' check (match_mode in ('exact', 'substring')),
...
values
  ('kill yourself', 'kill yourself', 'substring', 'hard', 'HARD_BLOCKED_TERM'),
  ('kys', 'kys', 'exact', 'hard', 'HARD_BLOCKED_TERM'),
