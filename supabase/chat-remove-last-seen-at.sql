-- Remove obsolete participant activity tracking from live chat admissions.
--
-- Replace join_event_chat before dropping the column so deployed databases do
-- not retain a function body that tries to write removed activity metadata.
...
--   and table_name = 'event_chat_participants'
--   and column_name = 'joined_at'
-- order by column_name;
--
-- Expected: one joined_at row.
