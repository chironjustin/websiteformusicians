...
create or replace function public.get_chat_admission_status_test(
  p_event_id uuid,
  p_session_id uuid
)
returns jsonb
...
grant execute on function public.get_chat_admission_status_test(uuid, uuid) to anon, authenticated;
